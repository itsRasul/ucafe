...
const base = { DATABASE_URL: "postgresql://user:pass@localhost:5432/cafexa", REDIS_URL: "redis://localhost:6379", PLATFORM_BASE_DOMAIN: "cafexa.test", ACCESS_TOKEN_SECRET: "a".repeat(32), AUTH_PEPPER: "b".repeat(32), PII_ENCRYPTION_KEY: Buffer.alloc(32).toString("base64"), INTERNAL_PROXY_SECRET: "c".repeat(32), S3_ENDPOINT: "https://objects.example.test", S3_REGION: "us-east-1", S3_BUCKET: "cafexa-media", S3_ACCESS_KEY: "access", S3_SECRET_KEY: "secret-value", PAYMENT_CALLBACK_BASE_URL: "https://api.cafexa.test" };
