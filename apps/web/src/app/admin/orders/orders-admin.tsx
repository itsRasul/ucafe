...
type OrderDetail = OrderSummary & { subtotalBeforeDiscountToman: string; discountTotalToman: string; paymentMethod: "OFFLINE"; deliveryAddressSnapshot: { label: string | null; addressLine: string } | null; customerNote: string | null; nextStatuses: Status[]; items: Array<{ id: string; itemName: string; variantName: string | null; unitPriceToman: string; originalUnitPriceToman: string; discountAmountToman: string; promotionName: string | null; quantity: number; lineTotalToman: string }> };
