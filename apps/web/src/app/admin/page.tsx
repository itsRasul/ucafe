...
const modules: Array<{ title: string; detail: string; href: string; permissions: TenantPermission[]; feature?: "inventory"; future?: boolean }> = [
  ...
  { title: "موجودی", detail: "موجودی کالا، اصلاحات و انبارگردانی", href: "/admin/inventory", permissions: ["inventory.read", "inventory.manage"], feature: "inventory" },
