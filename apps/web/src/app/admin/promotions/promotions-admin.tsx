...
type Promotion = { id: string; name: string; description: string | null; isActive: boolean; status: string; startAt: string | null; endAt: string | null; priority: number; rewardType: RewardType; rewardValue: string; targets: Target[]; entireOrder: boolean; minimumSubtotalToman: string | null; maxDiscountToman: string | null; coupon: { code: string; isActive: boolean; startsAt: string | null; expiresAt: string | null; totalUsageLimit: number | null; perCustomerUsageLimit: number | null } | null };
