...
type OrderDetail = OrderSummary & { deliveryAddressSnapshot: AddressSnapshot | null; customerNote: string | null; statusChangedAt: string | null; items: Array<{ id: string; itemName: string; variantName: string | null; unitPriceToman: string; originalUnitPriceToman: string; discountAmountToman: string; promotionName: string | null; quantity: number; lineTotalToman: string }> };
