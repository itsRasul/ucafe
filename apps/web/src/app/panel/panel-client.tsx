...
type OrderSummary = { id: string; status: OrderStatus; deliveryMethod: DeliveryMethod; paymentMethod: "OFFLINE"; totalAmountToman: string; subtotalBeforeDiscountToman: string; discountTotalToman: string; createdAt: string; updatedAt: string };
