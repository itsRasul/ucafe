...
5. The service serializes duplicate client checkout keys, rechecks the feature and settings, resolves the primary branch and client, owns/creates a valid address, and recalculates lines and total.
