...
- Tenant owners with the Analytics plan feature can use the Phase 1 dashboard for delivered-order revenue, completed orders, average order value, unique purchasing clients, local-period comparisons, and revenue/order/AOV trends. Delivered value is not verified cash collection; see [ANALYTICS.md](ANALYTICS.md).
