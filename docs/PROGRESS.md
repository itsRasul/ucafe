# Cafexa progress checkpoint

**Checkpoint date:** 2026-09-04 (Asia/Tehran)
...
- Dedicated hostname-aware Cafexa platform landing page on the base domain, separate from tenant storefronts, with a Persian RTL dark-blue AIDA presentation, product UI demonstrations, services, benefits, collaboration process, live Silver pricing, FAQ, responsive navigation and reduced-motion-aware GSAP enhancement.
...
- Reservation dates display ISO/Gregorian; a Jalali-display decision is open.
...
- Whether first-launch public dates should display Jalali while the API retains ISO dates.
